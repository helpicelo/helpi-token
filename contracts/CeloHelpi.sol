...
contract CeloHelpi is IERC20, Ownable {
    ...
    string public constant name = "CeloHelpi";
    string public constant symbol = "cHLP";
    ...
    constructor(address _liquidityMiningAddress, address _stakingAddress, address _marketingAddress, address _factoryAddress, address _weth) {
        ...
        transfer(liquidityMiningAddress, 500000 ether);
